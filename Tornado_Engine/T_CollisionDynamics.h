...
namespace T_CollisionDynamics {
	...
	{
	public:
		static bool T_IsColliding(Body_Physics::T_Body* objectA, Body_Physics::T_Body* objectB);
		static bool T_IsCollidingCircleCircle(Body_Physics::T_Body* objectA, Body_Physics::T_Body* objectB);
